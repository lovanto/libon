    ...
    <div class="background" style="height: 1000px;" id="top">
      <table style="padding-top: 10px; padding-bottom: 10px;" width=100% border="0px" id="navbar">
        <tr>
          ...
          <td width="30px">
            <a href="homeuser.php"><font class="navtext zoom">Beranda</font></a>
          </td>
          <td width="30px">
            <a href="homeuser.php?page=buku"><font class="navtext zoom">Data&nbsp;Buku</font></a>
          </td>
          <td width="30px">
            <a href="homeuser.php?page=pustakawan"><font class="navtext zoom">Data&nbsp;Pustakan</font></a>
          </td>
          <td width="30px">
            <a href="homeuser.php?page=member"><font class="navtext zoom">Data&nbsp;Member</font></a>
          </td>
          <td width="20px"></td>
        </tr>
      </table>
            ...
            <tr>
              ...
              <td width="25%" valign="top">
                ...
                <div class="data" align="center" style="background-color: hsla(0, 0%, 100%, 0.71); width: 90%; height: 220px; border-radius: 5px; margin-left: 30px; padding-top: 15px;">
                  ...
                  <p style="font-weight: bolder; margin-top: 15px;"><?=$nis?></p>
                  <p style="font-weight: bolder; margin-top: 10px;"><?=$user?></p>
                  <p style="font-weight: bolder; margin-top: 10px;"><?=$member?></p>
                </div>
                <br>
