...
<div style=" padding-top: 20px; overflow: scroll; height: 870px;" class="fontku">
  ...
  <div id="open-modal" class="modal-window">
      ...
      <div>
        <form action="php/code.php" method="POST">
          <table width="100%" border="0">
            <tbody>
              <tr>
                <td width="125" align="left" valign="top">No.Pustakawan</td><form action="php/code3.php" method="POST">
                <td width="417" align="left" valign="top" style="padding-right: 20px"><input type="text" name="no_pus" placeholder="Nomor Pustakawan" class="form-control" required/></td>
            ...
            <input type="submit" value="Simpan Pustakawan" name="Submit" class="btn btn-primary" style="float: right;" />
          </form>
        </div>
      </div>
    </div>
    ...
    <form action="" method="POST" name="filter">
      <div class="input-group col-md-5 col-md-offset-7" style="float: left; margin-left: 30px;">
    ...
    <div style="padding: 30px;">
      ...
      <table border="0">
        <thead>
          <tr>
            <th scope="col" style="width: 30px; text-align: center; padding-right: 5px; padding-left: 5px;">#</th>
            <th scope="col" style="width: 100px; padding-right: 5px; padding-left: 5px;">No.Pustakawan</th>
            <th scope="col" style="width: 150px; padding-right: 5px; padding-left: 5px;">Nama</th>
            <th scope="col" style="width: 200px; padding-right: 5px; padding-left: 5px;">TTL</th>
            <th scope="col" style="width: 100px; padding-right: 5px; padding-left: 5px;">Kelamin</th>
            <th scope="col" style="width: 100px; padding-right: 5px; padding-left: 5px;">No.Telp</th>
            <th scope="col" style="width: 300px; padding-right: 5px; padding-left: 5px;">Alamat</th>
            <th scope="col" style="width: 150px; padding-right: 5px; padding-left: 5px;">Email</th>
            <th scope="col" style="width: 250px; padding-right: 5px; padding-left: 5px; text-align: center; vertical-align : center;">Opsi</th>
          </tr>
        </thead>
        <tr>
